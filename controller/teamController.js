...
const getTeamAfterCreate = async (req, res) => {
  try {
    const user = req.user;
...
module.exports.getTeamAfterCreate = getTeamAfterCreate;
...
const updateTeam = async (req, res) => {
  ...
  try {
    ...
    const team = await teamModel.findOne({ _id: teamId, isDeleted: false });
